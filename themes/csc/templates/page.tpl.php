...
<div id="header-icons">
  <ul>
   ...
   <li><a target="_blank" alt="Give Now" class="noxhr top-anchor" href="http://giving.virginia.edu/contemplativesciences"><?php print_image('gift_icon.png', 24, 27, "Give Now", 'class="top-icons" id="calendar-icon"');?><div class="header-icon-text">Give Now</div></a></li>
    ...
    <!--<li><a alt="Calendar" id="calendar-link" href="<?php echo url('csc_calendar');?>"><?php print_image('calendar_icon.png', 24, 27, "Calendar", 'class="top-icons" id="calendar-icon"');?><div class="header-icon-text">calendar</div></a></li>-->
